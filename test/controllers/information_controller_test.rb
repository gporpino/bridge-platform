...
class InformationControllerTest < ActionController::TestCase
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post :create, information: { description: @information.description, idea: @information.idea, purpose: @information.purpose, responsible: @information.responsible }
    end
  ...
  test "should update information" do
    patch :update, id: @information, information: { description: @information.description, idea: @information.idea, purpose: @information.purpose, responsible: @information.responsible }
    assert_redirected_to information_path(assigns(:information))
  end
